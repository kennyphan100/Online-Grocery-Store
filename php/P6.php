...
<body>
    ...
    <div class="container" id="register">
        ...
        <form action="signupuser.php" method="POST">
            ...
            <input name="Password" type="password" id="Password1" alert="One uppercase, one lowercase, one number and at least 8 characters required." title="One uppercase, one lowercase, one number and at least 8 characters required."
                required/><br/><br/>
